...
import { MessageContact } from "../../Constants/chatConstant";
    ...
    <div className={`  p-4 border-r  border-gray-200 w-full h-full `}>
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full p-2 rounded-full bg-violet-100 font-semibold focus:outline-none"
        />
      </div>
      ...
      <ul className="space-y-4 h-[70vh] overflow-auto  hideScrollbar">
        {filteredContacts.map((contact) => (
          <li
            key={contact.id}
            onClick={() => {
              setselectedChat(contact.id), setMobileChatlist(true);
            }}
